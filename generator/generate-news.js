...
.source{margin-top:30px;color:#666}
</style>
</head>
<body>
<div class="container">
...
<img src="${img}">
<p>${content}</p>
<div class="source">Sumber: ${source}</div>
</div>
</body>
</html>`
}
...
articles=[
{title:"Berita Teknologi Terbaru",description:"Perkembangan teknologi terbaru sedang menjadi perhatian dunia.",source:{name:"Tasik News"}},
{title:"Ekonomi Global Mengalami Perubahan",description:"Situasi ekonomi global mengalami dinamika baru.",source:{name:"Tasik News"}}
]
}
...
const title=rewrite(art.title||"Berita terbaru")
const content=rewrite(art.description||art.content||"Informasi berita terbaru dari berbagai sumber.")
...
const html=template(title,content,img,source)
